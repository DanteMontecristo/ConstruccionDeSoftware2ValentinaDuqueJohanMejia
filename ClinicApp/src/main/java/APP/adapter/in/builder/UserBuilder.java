...
public class UserBuilder {
	...
	public User build(String name, String document, String email, String phoneNumber, String age, String address, String role, String userName, String password) throws Exception {
		User user = new User();
