...
public class NurseController {
    ...
    public ResponseEntity<Void> searchPatient(@RequestBody PatientRequest request) throws Exception {
        Patient patient = patientRestMapper.toDomain(request);
    ...
    @PostMapping("/visit")
    public ResponseEntity<Void> registerVisit(@RequestBody PatientRequest request) throws Exception {
        Patient patient = patientRestMapper.toDomain(request);
